cc.Class({
	...
	hanldeListGameSlotAPI(data){
		for (let i = 1; i < this.gameListApi.children.length; i++) {
	...
	getDataLogin() {
		...
		require("SendRequest").getIns().MST_Client_Get_Game_List_Jili();
